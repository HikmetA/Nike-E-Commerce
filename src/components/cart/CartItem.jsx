        ...
        <div className='flex items-center gap-5'>
          ...
          <div className='grid items-center gap-4'>
            <div className='grid items-center leading-none'>
              <h1 className='font-medium texr-lg text-slate-900 lg:text-sm'>{title}</h1>
            ...
            <div className='flex items-center justify-around w-full'>
              ...
              <div className='bg-theme-cart rounded text-white font-medium lg:text-xs w-7 h-6 lg:w-6 lg:h-5 flex items-center justify-center'>{cartQuantity}</div>
